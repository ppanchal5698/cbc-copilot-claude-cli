...
truth and nothing here is hand-maintained.
    ...
    python -m catalog_index.rebuild              # index anything new or changed
    python -m catalog_index.rebuild --force      # re-read everything
    python -m catalog_index.rebuild --verify     # report only, change nothing
"""
...
from catalog_index import db, pipeline, registry
from catalog_index.db import REPO_ROOT
